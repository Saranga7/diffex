...
wandb.login(key = "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")
...
def train(cfg: DictConfig) -> None:
    ...
    optimizer: torch.optim.Optimizer = instantiate(
        cfg.hparams.hparams.optimizer,
        list(model.parameters()) + list(projector.parameters())
        if cfg.train_projector
        else model.parameters(),
    )
    scheduler = instantiate(cfg.hparams.hparams.scheduler, optimizer)
    ...
    if cfg.tensorboard:
        ...
        wandb.init(project = "DiffaeCLR_Bio_prod", entity = "saranga7")
    ...
    trainer = Trainer(
        ...
        scheduler=scheduler,
        grad_clip_max_norm=cfg.hparams.hparams.grad_clip_max_norm,
        writer=writer,
        save_path=save_path,
